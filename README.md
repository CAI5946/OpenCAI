...
- 普通文本：发送给当前 execution mode。默认 `agent` mode 走 Agent Loop；`workflow` mode 走 Workflow Planner / WorkflowRunner。
...
- `/mode workflow`：普通文本自动走当前 Workflow Planner / WorkflowRunner。
